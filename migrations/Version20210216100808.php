 ...
 */
final class Version20210216100808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD created_by_id INT DEFAULT NULL, ADD created_at DATETIME NOT NULL');
